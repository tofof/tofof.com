Title: Markdown/Pelican Testing
Date: 3/19/2015 11:46:37 AM
Category: Projects
Tags: Website, Markdown, Pelican
Summary: In this article, I test the Markdown Cheatsheet supplied by the SublimeText *Markdown Preview* package to see how Pelican and my theme handle the various elements. I'm also toying with the summary feature to separate this text from the article itself.

Below, I test the Markdown Cheatsheet supplied by the SublimeText *Markdown Preview* package to see how Pelican and my theme handle the various elements. 
...
Insert `[ TOC ]` without spaces to generate a table of contents (builtin parsers only).[^note-again]
...
[^note-again]: I added this note. I don't have anything to say about Tables of Contents other than that the feature is not present in Pelican's markdown to html conversion. This is mostly just the second note, for testing. These should be latin numerals rather than roman.